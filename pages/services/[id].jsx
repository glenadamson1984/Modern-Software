  ...
  if (!isDesktop) {
    return (
      <SubPageLayout subTitle={"How we work?"}>
        <div className="pb-10">
          <div className="px-6 pt-16 text-4xl font-thin font-baloo text-pink sm:pt-8 sm:flex-1">
            {servicesData?.attributes?.title}
          </div>

          <div className="px-6 pt-16 text-xl font-thin font-baloo sm:pt-8">
            {servicesData?.attributes?.service_description}
          </div>
        </div>
        <div className="flex flex-row items-center pb-10">
          <div className="flex-col flex-1">
            <div className="px-6 pt-8 text-4xl font-thin font-baloo text-pink ">
              How we work
            </div>
            <div className="flex flex-col justify-between px-6">
              <div className="flex flex-col">
                <div className="pt-4 text-xl font-thin font-baloo">
                  <span className="text-pink">Planning</span>
                </div>
                <div className="text-xl font-thin font-baloo">
