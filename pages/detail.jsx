...
//                     <span className="c-pill u-fill-shade-dark">
//                       Success Story
//                     </span>
//                   </div>
//                   <h1 className="c-heading +case-study">
//                     Independent.ie apps the driving force for online
//                     subscription purchases{" "}
//                   </h1>
//                   <p>
//                     <p className="u-beta">
//                       The custom built native apps for independent.ie have
//                       unlocked an industry leading, highly engaged digital
//                       readership who consume more content, visit more frequently
//                       and purchase more subscriptions than all other digital
...
//                       <img
//                         src="https://gcdtech.com/wp-content/uploads/2020/12/inm-logo-white.svg"
...
//                 <img src="https://gcdtech.com/wp-content/uploads/2020/12/Independent-1920x1175.png" />
//               </div>
//             </div>
//           </div>
//
...
//                     Independent.ie approached us seeking a technology partner to
//                     assist them with two key objectives:&nbsp;
//                   </p>
//
...
//                           Design and develop a news app for Independent.ie
//                           readers that is fully optimised for mobile reading and
//                           delivers a highly engaged audience.&nbsp;
//                         </p>
//                       </div>
...
//                         </div>
//                         <p className="has-text-align-center">
//                           Driveeee purchases and sign ups, via the app, to the
//                           paid for Independent.ie news subscription service,
//                           offering readers paid for access to premium content.
//                         </p>
//                       </div>
//                     </div>
//                   </div>
...
//
//                   <p className="has-text-align-center has-medium-font-size">
//                     A reimagined and redesigned collection of native apps were
//                     developed and launched, for use across both iOS and Android
...
//                     were designed with user experience at their core. The apps
//                     provide readers with access to the latest breaking news, as
//                     well as local and international news articles across all
//                     sectors, including sport, business, lifestyle and
//                     entertainment from both the Irish Independent and the Sunday
//                     Independent.
//                   </p>
//
//                   <div
...
//
//                   <p className="has-text-align-center has-medium-font-size">
//                     To drive purchases of news subscriptions, an{" "}
//                     <strong>in app purchase experience</strong> was designed and
//                     implemented across both apps to enable readers to
//                     frictionlessly sign up and subscribe to read additional and
//                     premium content directly within the app itself. This
//                     purchasing option was deemed essential due to its ease of
//                     use, the immediate access it grants and the fact that it
//                     remains the most popular method by which people purchase
//                     within apps.
//                   </p>
//
//                   <div
...
//
//                   <p className="has-text-align-center has-medium-font-size">
//                     To cater for those readers who subscribed outside of the app
//                     and to provide a consistent experience across all platforms,
//                     a login function was developed within the app itself to
//                     allow subscribers to login using their existing web
//                     credentials and access their premium content.&nbsp;&nbsp;
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//
//                   <p className="has-text-align-center has-medium-font-size">
//                     The apps are delivering the most engaged audience across all
//                     Independent.ie digital platforms, with app users visiting{" "}
//                     <strong>more frequently</strong> (x5 times more) and{" "}
//                     <strong>reading&nbsp;50% more articles</strong> on every
//                     visit, compared to web.
//                   </p>
//
...
//
//                   <p className="has-text-align-center has-medium-font-size">
//                     The introduction of in-app purchasing has also proven to be
//                     the most effective driver for purchases of news
//                     subscriptions, with over <strong>42%</strong> of all
//                     subscriptions originating via in-app purchases, despite the
//                     apps accounting for only <strong>9%</strong> of overall
//                     digital readership. The frictionless method, coupled with
//                     the highly engaged behaviour, is a recipe for success it
//                     would seem!&nbsp;&nbsp;
//                   </p>
//
//                   <p className="has-text-align-center has-medium-font-size">
//                     To top it all off, the Independent.ie app has been
//                     recognised and awarded as ‘News App of the Year’ at the
//                     prestigious UK App Awards.&nbsp;
//                   </p>
//
//                   <div
//                     style={{ height: "33px" }}
...
//             <div
//               id=""
//               className="c-quote u-pad-x3 u-pad u-pad-x4@m u-pad-x5@l u-fill-grey"
//             >
...
//                     I am delighted that our technology partner GCD has been
//                     recognised for the great work they do alongside our internal
//                     technology and product team here in INM, as we collectively
//                     mature our digital offerings to be where our customers
//                     expect us to be, while exceeding their expectations when we
//                     get there. A well merited recognition for the GCD team.
//                   </p>
...
//             {/*    <div*/}
//             {/*      className="c-media-text u-white +contents-flipped u-align-items-center +one-fifth"*/}
...
//             {/*              Independent.ie is the online publication for the Irish*/}
//             {/*              Independent, delivering both national and global news*/}
//             {/*              across various websites and app platforms. Owned and*/}
//             {/*              operated by Independent News &amp; Media (a subsidiary*/}
//             {/*              of the international media organisation MediaHuis),*/}
//             {/*              the publication is one of many publishing brands*/}
//             {/*              within the group, which includes Belfast Telegraph,*/}
//             {/*              Sunday Independent, Sunday World, Evening Herald and a*/}
//             {/*              range of regional titles.*/}
//             {/*            </span>*/}
//             {/*          </p>*/}
//             {/*        </div>*/}
//             {/*      </div>*/}
...
//             {/*            className="style-svg u-fill-svg-white replaced-svg svg-replaced-1"*/}
//             {/*          >*/}
//             {/*            <path*/}
//             {/*              id="SVGID-3"*/}
//             {/*              className="st0"*/}
...
//                         style={{ width: "410.667px", marginRight: "16px" }}
//                       >
//                         <div className="c-card">
//                           <div className="c-card +stacked is-in-view">
//                             <a href="https://gcdtech.com/case-studies/fane-valley/">
...
//                                   alt="Fane Valley"
//                                   className="ls-is-cached lazyloaded"
//                                   src="https://gcdtech.com/wp-content/uploads/2020/03/247815_164109596984846_5290859_n-600x400.jpg"
//                                 />
//                               </div>
//                             </a>
...
//                                 <a href="https://gcdtech.com/case-studies/fane-valley/">
//                                   12% increase in online revenue
//                                 </a>
//                               </h2>
//                               The custom built, fully integrated e-commerce
//                               website for Fane Valley Stores has driven a strong
//                               increase in online revenue and online transactions
//                               for the business, with significant and continued
//                               revenue growth being seen on mobile devices.
//                             </div>
//                           </div>
//                         </div>
//                       </li>
...
//                     With a few details we’ll be able to kickstart your custom
//                     software project.
//                   </p>
//                   <a
