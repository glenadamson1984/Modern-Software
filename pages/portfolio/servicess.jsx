            ...
            <div className="c-hero">
              ...
              <div className="o-grid-box@m +cols-8@m +loose">
                <div className="o-grid-item +span-6@m u-align-self-center@m">
                  <div className="u-marg-bottom"><span className="c-pill u-fill-shade-dark">Success Story</span></div>
                  <h1 className="c-heading +case-study">
                    Independent.ie apps the driving force for online subscription purchases </h1>
                  <p>
                    <p className="u-beta">The custom built native apps for independent.ie have unlocked an industry leading,
                      highly engaged digital readership who consume more content, visit more frequently and purchase
                      more subscriptions than all other digital platforms across the group.
                    </p>
                  </p>
                </div>
                <div className="o-grid-item +span-2@m u-hide@m-">
                  <div className="u-fill-shade">
                    <div className="u-pad-x2 u-fill-shade u-align-center">
                      <img src="https://gcdtech.com/wp-content/uploads/2020/12/inm-logo-white.svg"
            ...
            <div className="grids-section grids-s-72f4ddcd-bf8e-4e04-aa68-efca29a7ad2a +narrow grids-is-stretch alignwide">
              <div className="grids-s-w_i">
                <div className="grids-area grids-a-f8d92a1c-f3f3-48ce-8037-915d660093ad">
                  ...
                  <p className="has-text-align-center has-medium-font-size">Independent.ie approached us seeking a technology partner to assist them with two key objectives:&nbsp;</p>
                  ...
                  <div className="grids-section grids-s-95d108e4-4b61-4f66-9b6b-66beaa2c20f2 grids-is-stretch">
                    <div className="grids-s-w_i">
                      <div className="grids-area grids-a-38a1d58f-2ac5-4e27-a045-3056201ecb34">
                        ...
                        <p className="has-text-align-center">Design and develop a news app for Independent.ie readers that is fully optimised for mobile reading and delivers a highly engaged audience.&nbsp;</p>
                      </div>
                      <div className="grids-area grids-a-5a78b234-211f-4f99-8eee-6fd5c8c9bf1e">
                        <div className=" c-heading s-cms-content u-marg-bottom">
                          <h1 className="has-text-align-center">2.</h1>
                        </div>
                        <p className="has-text-align-center">Drive purchases and sign ups, via the app, to the paid for Independent.ie news subscription service, offering readers paid for access to premium content.</p>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="c-card">
                          <div className="c-card +stacked is-in-view">
                            ...
                            <div className="c-card__content +centered">
                              <h2 className="c-heading +h4 u-pad-bottom"><a href="https://gcdtech.com/case-studies/fane-valley/">12% increase in online revenue</a></h2>
                              The custom built, fully integrated e-commerce website for Fane Valley Stores has driven a strong increase in online revenue and online transactions for the business, with significant and continued revenue
                              growth being seen on mobile devices.
                            </div>
                          </div>
                        </div>
                      </li>
